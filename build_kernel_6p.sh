...
zip -r ../GoogyMax-6P-MM_Kernel_v${1}_Enforcing.zip .
...
cd /home/anas/Nexus_6P/Release
zip -r ../GoogyMax-6P-MM_Kernel_v${1}_Permissive.zip .

adb push /home/anas/Nexus_6P/GoogyMax-6P-MM_Kernel_v${1}_Permissive.zip /sdcard/GoogyMax-6P-MM_Kernel_v${1}_Permissive.zip

adb kill-server

echo "GoogyMax-6P_Kernel-MM_v${1} READY !"
